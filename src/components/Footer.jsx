            ...
            <div className="mx-auto w-full max-w-[1080px] px-5 md:px-4">
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-sm leading-relaxed text-[#8c7356] break-words">
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-3 text-sm">
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Phim Đang Chiếu</Link></li>
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Phim Sắp Chiếu</Link></li>
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Hệ thống Rạp</Link></li>
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Khuyến mãi</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-3 text-sm">
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Điều khoản sử dụng</Link></li>
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Chính sách bảo mật</Link></li>
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Câu hỏi thường gặp (FAQ)</Link></li>
                            <li><Link to="/" className="transition hover:text-white hover:underline break-words">Liên hệ</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-3 text-sm">
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span className="text-white break-all">support@gzacinema.com</span>
                            </li>
                            <li className="flex items-start gap-2">
